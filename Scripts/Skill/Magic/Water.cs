...
namespace MyGame
{
    public class Water : Magic
    {
        ...
        protected override void Handleuse()
        {
            ...
            animatorHandler.PlayTargetAnimation("Water", true);
            Invoke("Play", 0.75f);
        ...
        private void Play()
        {
            vFXAndLightsManager.PlayParticle(vFXAndLightsManager.waterParticle, target.position);
        }

        private void Stop()
        {
            vFXAndLightsManager.StopParticle(vFXAndLightsManager.waterParticle);
        }
